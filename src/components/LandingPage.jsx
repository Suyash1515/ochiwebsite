            ...
            {["We Create", "Eye-Opening", "Presentations"].map((item,index)=>{
                ...
                <div key={index} className='masker'>
                    <div className='w-fit flex overflow-hidden items-center'>
                        {index===1 && (
                        <motion.div initial={{width:0}} animate={{width:"7.5vw"}} transition={{ease:[0.76,0,0.24,1],duration:1}} className='w-[7.5vw] h-[5vw] relative'>
                            <img className='py-3' src='https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg'></img>
                        </motion.div>
                        )}
